...
import com.example.menglucywhh.myquarter.adapter.PhotosAdapter;
 ...
 */
public class PhotosFragment extends Fragment implements SatinView {
    ...
    public void success(SatinBean bean) {
        PhotosAdapter satinAdapter = new PhotosAdapter(getActivity());
